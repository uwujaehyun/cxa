...
module.exports = {
  addToMany: function addToMany(activity, feeds, callback) {
    /**
  ...
  followMany: function followMany(follows, callbackOrActivityCopyLimit, callback) {
    /**
  ...
  unfollowMany: function unfollowMany(unfollows, callback) {
    /**
  ...
  makeSignedRequest: function makeSignedRequest(kwargs, cb) {
    /**
